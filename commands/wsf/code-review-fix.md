...
<execution_context>
@~/.claude/wsf/workflows/code-review-fix.md
</execution_context>
...
Context files (CLAUDE.md, REVIEW.md, phase state) are resolved inside the workflow via `wsf-tools init phase-op` and delegated to agent via config blocks.
</context>

<process>
This command is a thin dispatch layer. It parses arguments and delegates to the workflow.

Execute the code-review-fix workflow from @~/.claude/wsf/workflows/code-review-fix.md end-to-end.
