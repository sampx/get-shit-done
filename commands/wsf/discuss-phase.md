...
<execution_context>
@~/.claude/wsf/workflows/discuss-phase.md
@~/.claude/wsf/workflows/discuss-phase-assumptions.md
@~/.claude/wsf/workflows/discuss-phase-power.md
@~/.claude/wsf/templates/context.md
</execution_context>
...
If `DISCUSS_MODE` is `"assumptions"`: Read and execute @~/.claude/wsf/workflows/discuss-phase-assumptions.md end-to-end.

If `DISCUSS_MODE` is `"discuss"` (or unset, or any other value): Read and execute @~/.claude/wsf/workflows/discuss-phase.md end-to-end.
