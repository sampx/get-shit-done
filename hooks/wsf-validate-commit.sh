#!/bin/bash
# wsf-validate-commit.sh — PreToolUse hook: enforce Conventional Commits format
...
# Uses Node.js for JSON parsing (always available in WSF projects, no jq dependency).
#
