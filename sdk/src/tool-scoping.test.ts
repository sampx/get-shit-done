...
describe('PHASE_AGENT_MAP', () => {
  ...
  it('execute maps to wsf-executor.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Execute]).toBe('wsf-executor.md');
  });

  it('research maps to wsf-phase-researcher.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Research]).toBe('wsf-phase-researcher.md');
  });

  it('plan maps to wsf-planner.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Plan]).toBe('wsf-planner.md');
  });

  it('verify maps to wsf-verifier.md', () => {
    expect(PHASE_AGENT_MAP[PhaseType.Verify]).toBe('wsf-verifier.md');
  });
