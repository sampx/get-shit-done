 ...
 *
 * Provides a cross-project learnings store at ~/.wsf/knowledge/.
...
const DEFAULT_STORE_DIR = path.join(os.homedir(), '.wsf', 'knowledge');
...
/**
 * Handle `wsf-tools learnings list`
...
/**
 * Handle `wsf-tools learnings query --tag <tag>`
 * @param {string} tag
 * @param {boolean} raw - Raw output flag
 */
...
/**
 * Handle `wsf-tools learnings copy`
...
/**
 * Handle `wsf-tools learnings prune --older-than <duration>`
...
/**
 * Handle `wsf-tools learnings delete <id>`
 * @param {string} id
 * @param {boolean} raw - Raw output flag
 */
