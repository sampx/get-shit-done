...
<!-- For checkpoint task examples and patterns, see @~/.claude/wsf/references/checkpoints.md -->
...
See `~/.claude/wsf/references/tdd.md` for TDD plan structure.
...
See `~/.claude/wsf/templates/user-setup.md` for full schema and examples
...
See `~/.claude/wsf/workflows/verify-phase.md` for verification logic.
