...
See ~/.claude/wsf/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/wsf/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/wsf/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/wsf/templates/discovery.md
...
Use ~/.claude/wsf/templates/discovery.md.
